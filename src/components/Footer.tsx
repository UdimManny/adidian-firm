      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-2xl font-bold text-blue-400 mb-4">Adidian Physiotherapy Clinic</h3>
              <p className="text-gray-300 leading-relaxed">
                Leading physiotherapy clinic in Abuja restoring mobility and empowering pain-free living through personalized, evidence-based physical therapy services. Serving Garki, Wuse, Maitama, and all areas of Abuja.
              </p>
            </div>
          ...
          <div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">
                    ...
                    Area 11, Garki, Abuja, FCT<br />
                    Beside Efab Properties Ltd<br />
                    <span className="text-sm text-blue-400">Premier Physiotherapy Clinic in Abuja</span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-gray-800 rounded-lg">
              <h5 className="font-semibold text-blue-400 mb-2">Physiotherapy Clinic Hours</h5>
              <div className="text-sm text-gray-300 space-y-1">
                <p>Mon - Fri: 8:00 AM - 6:00 PM</p>
                <p>Saturday: 9:00 AM - 4:00 PM</p>
                <p>Sunday: Physiotherapy by Appointment</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 text-sm">
              Leading physiotherapy clinic in Abuja. We stand for ADIDIAN: Accessibility, Diligence, Innovation, Distinguished care, 
              Industrious approach, Affordability, and Noble service for all our physical therapy patients.
            </p>
          </div>
        </div>
      </div>
